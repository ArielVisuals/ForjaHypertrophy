                ...
                <div key={k} className="grid grid-cols-2 md:grid-cols-[1fr_140px_70px_90px_70px_90px_32px] gap-2 items-end md:items-center border-b border-white/[0.04] pb-3 md:border-0 md:pb-0">
                  ...
                  <div className="flex items-end">
                    <button
                      ...
                      className="h-9 w-full md:w-8 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 hover:border-red-500/40 hover:text-red-300 flex items-center justify-center transition-all"
